                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: Text(
                                FFLocalizations.of(context).getText(
                                  'laz1y4s4' /* Fill out the information below... */,
                                ),
                                textAlign: TextAlign.center,
                              ...
                              child: RichText(
                                ...
                                text: TextSpan(
                                  children: [
                                    TextSpan(
                                      text: FFLocalizations.of(context).getText(
                                        'fkpi1pg1' /* Don't have an account?   */,
                                      ),
                                      style: TextStyle(),
                                    ),
                                    TextSpan(
                                      text: FFLocalizations.of(context).getText(
                                        'xo4449gn' /* Sign Up here */,
                                      ),
