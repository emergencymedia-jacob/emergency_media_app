                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        Text(
                          FFLocalizations.of(context).getText(
                            'o51azrfc' /* Good Morning, */,
                          ),
                          style: FlutterFlowTheme.of(context).headlineMedium,
                        ),
                        Text(
                          FFLocalizations.of(context).getText(
                            'de88bnay' /* Summary of your weekly brews */,
                          ),
                              ...
                              child: Padding(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    Text(
                                      FFLocalizations.of(context).getText(
                                        'ztbva27q' /* How to pour Latte Art */,
                                      ),
                                      style: FlutterFlowTheme.of(context)
                                          .titleLarge,
                                    ),
                                    Padding(
                                      ...
                                      child: AutoSizeText(
                                        FFLocalizations.of(context).getText(
                                          'kdjg7tn1' /* A wonderfully delicious 2 patt... */,
                                        ),
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Padding(
                                      ...
                                      child: AutoSizeText(
                                        FFLocalizations.of(context).getText(
                                          'jjos580y' /* Learn how to brew a delicious ... */,
                                        ),
                                        textAlign: TextAlign.start,
                                        style: FlutterFlowTheme.of(context)
                                            .bodySmall
